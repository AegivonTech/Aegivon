...
export const Footer = () => {
  return (
    <footer className="border-t border-white/5 bg-[#070a11] py-12 mt-20 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center text-sm text-secondary relative z-20">
        ...
        {/* Text hover effect */}
        <div className="hidden lg:flex h-[12rem] mt-8 -mb-8 w-full pointer-events-auto items-center justify-center">
          <TextHoverEffect text="AEGIVON" className="z-10" />
        </div>
      </div>
    </footer>
  );
